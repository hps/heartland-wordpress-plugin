    ...
    function shortcode($atts) {
        ...
        if ($modal) { ?>
								...
								<script language="javascript" type="text/javascript">
									...
									var <?php echo $prefix; ?>
									_requireShipping = true;
									<?php } else { ?>
									var <?php echo $prefix; ?>
									_requireShipping = false;
									<?php } ?>

									<?php if ($requireBilling) { ?>
									var <?php echo $prefix; ?>
									_requireBilling = true;
									<?php } else { ?>
									var <?php echo $prefix; ?>
									_requireBilling = false;
									<?php } ?>
                ...
                ?>
									...
									if (jQuery('#sss').length == 0)
										jQuery('head').append(jQuery('<link rel="stylesheet" type="text/css" />').attr('href', '<?php echo plugins_url( '
											assets / paybutton.css ', __FILE__ ); ?>').attr('id', 'sss'));
									...
									// BUILD CONTROLS
									var <?php echo $prefix; ?>
									_modal_html = "<a class='boxclose modal-close' id='boxclose'>&times;</a>";

									// HEADER
									<?php echo $prefix; ?>
									_modal_html += "<div id='modal-header'>";

									<?php echo $prefix; ?>
									_modal_html += "<div style='float: left;'>";
									<?php if (!isset($atts["productimage"])) { ?>
									<?php echo $prefix; ?>
									_modal_html += "<img src='<?php echo plugins_url('assets/donation.png', __FILE__); ?>' class='checkout-product-image' />";
									<?php } else if ($atts["productimage"] == 'none') { ?>
									<?php echo $prefix; ?>
									_modal_html += "<img src='<?php echo plugins_url('assets/transparent.png', __FILE__); ?>' class='checkout-product-image' />";
									<?php } else { ?>
									<?php echo $prefix; ?>
									_modal_html += "<img src='<?php echo isset($atts['productimage']) ? $atts["
									productimage "] : ''; ?>' class='checkout-product-image' />";
									<?php } ?>
									<?php echo $prefix; ?>
									_modal_html += "</div>";
									<?php echo $prefix; ?>
									_modal_html += "<input type='hidden' name='action' id='action' value='ssd_submit_payment'/>";
									<?php echo $prefix; ?>
									_modal_html += "<input type='hidden' name='product_sku' id='product_sku' value='<?php echo isset($atts['productid']) ? $atts['productid'] : get_the_title(); ?>'/>";
									<?php echo $prefix; ?>
									_modal_html += "<input type='hidden' name='product_id' id='product_id' value='<?php echo isset($atts['productid']) ? $atts['productid'] : get_the_ID(); ?>'/>";
									<?php echo $prefix; ?>
									_modal_html += "<div class='checkout-product-name'><?php echo isset($atts['productname']) ? $atts['productname'] : ''; ?></div>";

									if ('<?php echo isset($atts['
										amount ']) ? $atts['
										amount '] : '
										'; ?>' != '') {
										<?php echo $prefix; ?>
										_modal_html += "<div class='checkout-price'>$<?php echo isset($atts['amount']) ? $atts['amount'] : ''; ?></div>";
									} else {
										<?php echo $prefix; ?>
										_modal_html += "<div class='donation-price'>Dollar Amount<br />$&nbsp;<input type='text' name='donation_amount' id='donation_amount' class='checkout-input donation-field' placeholder='<?php echo $amountdefault; ?>'></div>";
									}
									...
									<?php echo $prefix; ?>
									_modal_html += "<div id='modal-body'>";

									// BILLING BODY
									var <?php echo $prefix; ?>
									_billing_html = "<div id='<?php echo $prefix; ?>_billing_panel'>";
									<?php echo $prefix; ?>
									_billing_html += "<div class='checkout-card-information'>Billing Information</div>";
									<?php echo $prefix; ?>
									_billing_html += "<div class='card-number'><input type='text' name='cardholder_name' id='cardholder_name' class='checkout-input checkout-card <?php echo $billingRequired; ?> ' placeholder='Name on Credit Card'></div>";
									<?php echo $prefix; ?>
									_billing_html += "<div class='card-number'><input type='text' name='cardholder_address' id='cardholder_address' class='checkout-input checkout-card <?php echo $billingRequired; ?>' placeholder='Credit Card Billing Address'></div>";
									<?php echo $prefix; ?>
									_billing_html += "<div class='card-number'>";
									<?php echo $prefix; ?>
									_billing_html += "<input type='text' name='cardholder_city' id='cardholder_city' class='checkout-input city-field<?php echo $billingRequired; ?>' placeholder='City'>";
									<?php if ($requireState) { ?>
									<?php echo $prefix; ?>
									_billing_html += "<select name='cardholder_state' id='cardholder_state' class='checkout-input state-field<?php echo $billingRequired; ?>'><option value='AL'>AL</option><option value='AK'>AK</option><option value='AZ'>AZ</option><option value='AR'>AR</option><option value='CA'>CA</option><option value='CO'>CO</option><option value='CT'>CT</option><option value='DC'>DC</option><option value='DE'>DE</option><option value='FL'>FL</option><option value='GA'>GA</option><option value='HI'>HI</option><option value='ID'>ID</option><option value='IL'>IL</option><option value='IN'>IN</option><option value='IA'>IA</option><option value='KS'>KS</option><option value='KY'>KY</option><option value='LA'>LA</option><option value='ME'>ME</option><option value='MD'>MD</option><option value='MA'>MA</option><option value='MI'>MI</option><option value='MN'>MN</option><option value='MS'>MS</option><option value='MO'>MO</option><option value='MT'>MT</option><option value='NE'>NE</option><option value='NV'>NV</option><option value='NH'>NH</option><option value='NJ'>NJ</option><option value='NM'>NM</option><option value='NY'>NY</option><option value='NC'>NC</option><option value='ND'>ND</option><option value='OH'>OH</option><option value='OK'>OK</option><option value='OR'>OR</option><option value='PA'>PA</option><option value='RI'>RI</option><option value='SC'>SC</option><option value='SD'>SD</option><option value='TN'>TN</option><option value='TX'>TX</option><option value='UT'>UT</option><option value='VT'>VT</option><option value='VA'>VA</option><option value='WA'>WA</option><option value='WV'>WV</option><option value='WI'>WI</option><option value='WY'>WY</option></select>";
									<?php } ?>
									<?php echo $prefix; ?>
									_billing_html += "<input type='text' name='cardholder_zip' id='cardholder_zip' class='checkout-input zip-field<?php echo $billingRequired; ?>' placeholder='Zip'>";
									<?php echo $prefix; ?>
									_billing_html += "</div>";

									// Additional Info BODY
									var <?php echo $prefix; ?>
									_additional_html = "<div id='<?php echo $prefix; ?>_additional_panel'>";
									<?php echo $prefix; ?>
									_additional_html += "<div class='back-button'><a href='#billing' id='<?php echo $prefix; ?>_additional_back'>back</a></div>";
									<?php echo $prefix; ?>
									_additional_html += "<div class='checkout-card-information'><?php echo $additionalInformationText; ?></div>";
									<?php echo $prefix; ?>
									_additional_html += "<div style='overflow-y: auto; height: 200px;'>";
									<?php
                if(count($additionalFields)>0){
                ...
                ?>
									<?php echo $prefix; ?>
									_additional_html += "</div>";
									<?php echo $prefix; ?>
									_additional_html += "<div class='pay-button button-next'><a href='#Purchase' id='<?php echo $prefix; ?>_additional_next_button'>Next</a><div class='pay-button-border'>&nbsp;</div></div>";
									<?php echo $prefix; ?>
									_additional_html += "<div class='powered_by'><img src='<?php echo plugins_url( 'assets/heart.png', __FILE__ ); ?>' /></div>";
									<?php echo $prefix; ?>
									_additional_html += "</div>";
									...
									if (<?php echo $prefix; ?>
										_requireShipping) {
										<?php echo $prefix; ?>
										_billing_html += "<div class='same_shipping'><input name='shipping_same' type='checkbox' id='shipping_same'>&nbsp;<label for='shipping_same'>Shipping Same As Billing</label></div>";
									}

									<?php echo $prefix; ?>
									_billing_html += "<div class='pay-button button-next'><a href='#Purchase' id='<?php echo $prefix; ?>_billing_next_button'>Next</a><div class='pay-button-border'>&nbsp;</div></div>";
									<?php echo $prefix; ?>
									_billing_html += "<div class='powered_by'><img src='<?php echo plugins_url( 'assets/heart.png', __FILE__ ); ?>' /></div>";
									<?php echo $prefix; ?>
									_billing_html += "</div>";

									// SHIPPING BODY
									var <?php echo $prefix; ?>
									_shipping_html = "<div id='<?php echo $prefix; ?>_shipping_panel'>";
									<?php echo $prefix; ?>
									_shipping_html += "<div class='back-button'><a href='#billing' id='<?php echo $prefix; ?>_shipping_back'>back</a></div>";
									<?php echo $prefix; ?>
									_shipping_html += "<div class='checkout-card-information'>Shipping Information</div>";
									<?php echo $prefix; ?>
									_shipping_html += "<div class='card-number'><input name='shipping_name' type='text' id='shipping_name' class='checkout-input checkout-card<?php echo $shippingRequired; ?>' placeholder='Shipping Name'></div>";
									<?php echo $prefix; ?>
									_shipping_html += "<div class='card-number'><input name='shipping_address' type='text' id='shipping_address' class='checkout-input checkout-card<?php echo $shippingRequired; ?>' placeholder='Address'></div>";
									<?php echo $prefix; ?>
									_shipping_html += "<div class='card-number'>";
									<?php echo $prefix; ?>
									_shipping_html += "<input type='text' name='shipping_city' id='shipping_city' class='checkout-input city-field<?php echo $shippingRequired; ?>' placeholder='City'>";
									<?php if ($requireState) { ?>
									<?php echo $prefix; ?>
									_shipping_html += "<select id='shipping_state' name='shipping_state' class='checkout-input state-field<?php echo $shippingRequired; ?>'><option value='AL'>AL</option><option value='AK'>AK</option><option value='AZ'>AZ</option><option value='AR'>AR</option><option value='CA'>CA</option><option value='CO'>CO</option><option value='CT'>CT</option><option value='DC'>DC</option><option value='DE'>DE</option><option value='FL'>FL</option><option value='GA'>GA</option><option value='HI'>HI</option><option value='ID'>ID</option><option value='IL'>IL</option><option value='IN'>IN</option><option value='IA'>IA</option><option value='KS'>KS</option><option value='KY'>KY</option><option value='LA'>LA</option><option value='ME'>ME</option><option value='MD'>MD</option><option value='MA'>MA</option><option value='MI'>MI</option><option value='MN'>MN</option><option value='MS'>MS</option><option value='MO'>MO</option><option value='MT'>MT</option><option value='NE'>NE</option><option value='NV'>NV</option><option value='NH'>NH</option><option value='NJ'>NJ</option><option value='NM'>NM</option><option value='NY'>NY</option><option value='NC'>NC</option><option value='ND'>ND</option><option value='OH'>OH</option><option value='OK'>OK</option><option value='OR'>OR</option><option value='PA'>PA</option><option value='RI'>RI</option><option value='SC'>SC</option><option value='SD'>SD</option><option value='TN'>TN</option><option value='TX'>TX</option><option value='UT'>UT</option><option value='VT'>VT</option><option value='VA'>VA</option><option value='WA'>WA</option><option value='WV'>WV</option><option value='WI'>WI</option><option value='WY'>WY</option></select>";
									<?php } ?>
									<?php echo $prefix; ?>
									_shipping_html += "<input type='text' name='shipping_zip' id='shipping_zip' class='checkout-input zip-field<?php echo $shippingRequired; ?>' placeholder='Zip'>";
									<?php echo $prefix; ?>
									_shipping_html += "</div>";
									<?php echo $prefix; ?>
									_shipping_html += "<div class='pay-button button-next'><a href='#Purchase' id='<?php echo $prefix; ?>_shipping_next_button'>Next</a><div class='pay-button-border'>&nbsp;</div></div>";
									<?php echo $prefix; ?>
									_shipping_html += "<div class='powered_by'><img src='<?php echo plugins_url('assets/heart.png', __FILE__); ?>' /></div>";
									<?php echo $prefix; ?>
									_shipping_html += "</div>";

									// CARD BODY
									var <?php echo $prefix; ?>
									_card_html = "<div id='<?php echo $prefix; ?>_card_panel'>";
									<?php echo $prefix; ?>
									_card_html += "<div class='back-button'><a href='#shipping' id='<?php echo $prefix; ?>_card_back'>back</a></div>";
									<?php echo $prefix; ?>
									_card_html += "<div class='checkout-card-information'>Card Information</div>";
									<?php echo $prefix; ?>
									_card_html += "<div class='card-number'><input type='text' id='card_number' class='checkout-input checkout-card required' placeholder='Credit Card'></div>";
									<?php echo $prefix; ?>
									_card_html += "<div class='card-exp'><input type='text' id='card_exp' class='checkout-exp required' placeholder='MM/YY'></div>";
									<?php echo $prefix; ?>
									_card_html += "<div class='card-cvc'><input type='text' id='card_cvc' class='checkout-exp' placeholder='CVC'></div>";
									<?php echo $prefix; ?>
									_card_html += "<div class='clearfixcheckout'>&nbsp;</div>";
									<?php echo $prefix; ?>
									_card_html += "<div class='email-reciept'><input name='email_reciept' type='checkbox' id='email_reciept' checked='true'>&nbsp;<label for='email_reciept'>Email Receipt</label></div>";
									<?php echo $prefix; ?>
									_card_html += "<div class='email-address'><input name='email_address' type='text' id='email_address' class='checkout-email' placeholder='Customer Email Address'></div>";
									<?php echo $prefix; ?>
									_card_html += "<div class='pay-button button-next'><a href='#Purchase' id='<?php echo $prefix; ?>_pay_button'><?php echo $buttonText; ?></a><div class='pay-button-border'>&nbsp;</div></div>";
									<?php echo $prefix; ?>
									_card_html += "<div class='powered_by'><img src='<?php echo plugins_url( 'assets/heart.png', __FILE__ ); ?>' /></div>";
									<?php echo $prefix; ?>
									_card_html += "</div>";

									// PROCESSING BODY
									var <?php echo $prefix; ?>
									_processing_html = "<div id='<?php echo $prefix; ?>_processing_panel'>";
									<?php echo $prefix; ?>
									_processing_html += "<div class='transaction-processing'>processing</div>";
									<?php echo $prefix; ?>
									_processing_html += "</div>";

									// FAILURE BODY
									var <?php echo $prefix; ?>
									_failure_html = "<div id='<?php echo $prefix; ?>_failure_panel'>";
									<?php echo $prefix; ?>
									_failure_html += "<div class='checkout-card-information'>Transaction Information</div>";
									<?php echo $prefix; ?>
									_failure_html += "<div class='transaction-error'>There was a problem while processing your card.</div>";
									<?php echo $prefix; ?>
									_failure_html += "<div class='pay-button button-next'><a href='#Purchase' id='<?php echo $prefix; ?>_retry_button'>Retry</a><div class='pay-button-border'>&nbsp;</div></div>";
									<?php echo $prefix; ?>
									_failure_html += "</div>";

									// SUCCESS BODY
									var <?php echo $prefix; ?>
									_success_html = "<div id='<?php echo $prefix; ?>_success_panel'>";
									<?php echo $prefix; ?>
									_success_html += "<div class='card-number'>Your Payment Was Successful!</div>";
									<?php echo $prefix; ?>
									_success_html += "</div>";

									<?php echo $prefix; ?>
									_modal_html += <?php echo $prefix; ?>
									_billing_html;
									<?php echo $prefix; ?>
									_modal_html += <?php echo $prefix; ?>
									_additional_html;
									...
									<?php echo $prefix; ?>
									_modal_html += "</div>"; // BODY

									// ACTIONS
									function <?php echo $prefix; ?>
									_trigger_payment() {
										...
										frame.load(function () {
											...
											stylesheet.attr('href', '<?php echo plugins_url( '
												assets / checkout.css ', __FILE__ ); ?>').attr('id', 'sss');
											...
											billingButton.on('click', function (event) {
												...
												if (continueProcessing) {
													...
													if (<?php echo $prefix; ?>
														_requireAdditionalInfo) {
														additionalPanel.fadeIn();
													} else if (<?php echo $prefix; ?>
														_requireShipping) {
														cardPanel.hide();
                            ...
                            ?>
											...
											cardBack.on("click", function (event) {
												...
												if ((<?php echo $prefix; ?>
														_requireShipping) && (!frameBody.find("#shipping_same").attr("checked"))) {
													shippingPanel.show();
												} else {
            ...
            ?>
											...
											<?php if ($requireBilling) { ?>
												...
												<table width="100%">
													...
													<tr>
														<td>Address:</td>
														<td>
															<input class="form-text<?php echo $billingRequired; ?>" name="billing_address" type="text" " /></td>
                            </tr>
                            <tr>
                                <td>City:</td>
													...
													<?php if ($requireState) { ?>
														...
														<?php } ?>
															<tr>
																...
																<td>
																	<input class="form-text<?php echo $billingRequired; ?>" name="billing_zip" type="text" "/></td>
                            </tr>
                        </table>
                    <?php } ?>
                            ...
                            <tr>
                                ...
                                <td><input class="form-text<?php echo $shippingRequired; ?>" name="shipping_firstname" type="text" " /></td>
															...
															<tr>
																<td>Last Name:</td>
																<td>
																	<input class="form-text<?php echo $shippingRequired; ?>" type="text" name="shipping_lastname" " /></td>
                            </tr>
                            <tr>
                                <td>Address:</td>
                                <td><input class="form-text<?php echo $shippingRequired; ?>" type="text" name="shipping_address" " /></td>
															...
															<tr>
																<td>City:</td>
																<td>
																	<input class="form-text<?php echo $shippingRequired; ?>" type="text" name="shipping_city" " /></td>
                            </tr>
                            <?php if ($requireState) { ?>
                                <tr>
                                    <td>State:</td>
                    ...
                    ?>
													...
													$('#<?php echo $prefix; ?>-securesubmit-button').bind('click', a <?php echo $prefix; ?>
														_handleSubmit);

													function a <?php echo $prefix; ?>
													_handleSubmit() {
